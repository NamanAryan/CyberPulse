...
{
    public class HrAnnouncementRepository
    {
        private readonly string _connectionString =
            ConfigurationManager.ConnectionStrings["CyberPulseDb"].ConnectionString;

        public List<HrAnnouncement> GetAll()
        {
            var list = new List<HrAnnouncement>();
            using (var conn = new SqlConnection(_connectionString))
            {
                using (var cmd = new SqlCommand("usp_GetHrAnnouncements", conn))
                {
        ...
        public HrAnnouncement GetById(int id)
        {
            using (var conn = new SqlConnection(_connectionString))
            {
                using (var cmd = new SqlCommand("usp_GetHrAnnouncementById", conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public int Insert(HrAnnouncement ann)
        {
            using (var conn = new SqlConnection(_connectionString))
            {
                using (var cmd = new SqlCommand("usp_InsertHrAnnouncement", conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void Update(HrAnnouncement ann)
        {
            using (var conn = new SqlConnection(_connectionString))
            {
                using (var cmd = new SqlCommand("usp_UpdateHrAnnouncement", conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void Delete(int id)
        {
            using (var conn = new SqlConnection(_connectionString))
            {
                using (var cmd = new SqlCommand("usp_DeleteHrAnnouncement", conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@ID", id);
        ...
        public List<HrAnnouncement> GetActive()
        {
            var list = new List<HrAnnouncement>();
            using (var conn = new SqlConnection(_connectionString))
            {
                using (var cmd = new SqlCommand("usp_GetActiveHrAnnouncements", conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    conn.Open();
                    using (var reader = cmd.ExecuteReader())
        ...
        public void ToggleActive(int id, bool isActive)
        {
            using (var conn = new SqlConnection(_connectionString))
            {
                using (var cmd = new SqlCommand("usp_ToggleHrAnnouncementActive", conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@ID", id);
        ...
        private HrAnnouncement MapAnnouncement(SqlDataReader reader)
        {
            return new HrAnnouncement
            {
